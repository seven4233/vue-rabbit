...
import {SkuObj, useCartStore} from "@/stores/cartStore";
...
<template>
    <div class="xtx-goods-page">
        <div class="container" v-if="goods.desc">
                        ...
                        <div class="goods-article">
                            ...
                            <div class="goods-tabs">
                                ...
                                <div class="goods-detail">
                                    ...
                                    <!-- 图片 -->
                                    <img v-for="item in goods.details.pictures" :key="item.id" :src="item" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- 24热榜+专题推荐 -->
